    ...
    <form class="form" action="" method="post" enctype="multipart/form-data">
        <div class="form__column">
            ...
            <div class="form__row">
                ...
                <input required class="form__input <?php if ($f->getError('email')): ?>form__input--error<?php endif; ?>"
            ...
            <div class="form__row">
                ...
                <input required class="form__input <?php if ($f->getError('password')): ?>form__input--error<?php endif; ?>"
            ...
            <div class="form__row">
                ...
                <input required class="form__input <?php if ($f->getError('name')): ?>form__input--error<?php endif; ?>"
